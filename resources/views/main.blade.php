    ...
    <div class="container">
        <form class="row mt-5">
            <div class="row centralizacao mb-3">
                <div class="col-md-3">
                    <select id="procedimentos" class="form-select desabilitar" >
                ...
                <div class="col-md-3">
                    <input type="text" class="form-control desabilitar" id="codigo_tuss" placeholder="Código TUSS">               
                </div>
                <div class="col-md-3">
            ...
            <hr>
            <div class="row centralizacao mb-3">
                <h3>Valores com acréscimos de 30%</h3>
                <div class="col-md-2">
                    <label for="" class="form-label">1º Auxiliar</label>
