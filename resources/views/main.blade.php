...
<head>
    ...
    <link rel="icon" href={{ asset('storage/icon/letter-z-icon.png') }} type="image/x-icon">
    <title>Zordon System</title> <!-- {{ config('app.name', 'Document') }} -->
        ...
        <form class="row mt-5">
            <div class="row centralizacao mb-3">
                ...
                <div class="col-md-4 d-flex justify-content-around">
                    ...
                    <button type="button" class="btn btn-outline-primary" id="add_auxiliar">Add Auxiliar</button>
